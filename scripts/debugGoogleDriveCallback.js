...
const logger = new Logger('debug-google-drive-callback');
...
const debugGoogleDriveCallback = async () => {
  try {
    await connectDB();
    ...
    console.log('Integration details:', {
      ...
      clientId: integration.clientId ? `${integration.clientId.substring(0, 10)}...` : 'MISSING'
    });
    ...
    const userId = '6916ede023a4625ca577da28'; // This should be a real user ID from your database
