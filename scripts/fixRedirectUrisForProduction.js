...
// Fix redirect URIs for production
const fixRedirectUrisForProduction = async () => {
  try {
    await connectDB();
    
    // Update all integrations to use production redirect URI
    ...
    console.log(`Updated ${result.modifiedCount} integrations with production redirect URI`);
