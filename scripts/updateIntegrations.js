...
const integrationUpdates = [
  {
    ...
    redirectUri: process.env.FRONTEND_URL ? `${process.env.FRONTEND_URL}/integrations/callback` : 'https://spark-frontend-production.up.railway.app/integrations/callback',
